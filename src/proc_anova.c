...
static void parse_proc_anova_stmt();
static void parse_proc_anova_body();
static void parse_model_stmt();
static void parse_model_options();
static void parse_explanatory_variable();
static void regression();
static int get_var_index();
...
static void prelim();
static int a_compute_G();
static void fit();
static void fit1(int, int);
static void compute_B();
static void compute_Yhat();
static void compute_ss();
static void model();
static void compute_means();
static void print_means();
static void parse_means_stmt();
static void parse_means_item();
